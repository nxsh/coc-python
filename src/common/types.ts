...
export interface IDisposableRegistry { push(disposable: Disposable): void }
...
export const BANNER_NAME_LS_SURVEY = 'LSSurveyBanner'
export const BANNER_NAME_PROPOSE_LS = 'ProposeLS'
export const BANNER_NAME_DS_SURVEY = 'DSSurveyBanner'
// export const BANNER_NAME_INTERACTIVE_SHIFTENTER = 'InteractiveShiftEnterBanner'
